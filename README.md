# Домашнее задание к занятию 5. «Оркестрация кластером Docker контейнеров на примере Docker Swarm» - `Горбачев Олег`
...
Чтобы получить зачёт, покажите вывод команды:
```
docker node ls
```
## Решение:
